        ...
        <template>
            <div class="new-51">
                ...
                <div class="content">
                    ...
                    <div class="list list-padding-without-bottom" v-if="recentGameList.gameList && recentGameList.gameList.length">
                        <!-- list -->

                        <div class="row-game inline"  v-for="(item, index) in recentGameList.gameList" :key="index" @click="startMGCGame(item)">
    ...
    methods: {
		getMGCGameCenterData() {
			...
			let args = {
				...
				app_id: this.$route.query.channel_id,
